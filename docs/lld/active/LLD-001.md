...
|---------|--------|-------|
| `test_stingray_rest.png` | Baseline generated via `pytest --generate-baselines` | Stored in `tests/visual/baselines/` |
...
| Technical Architect #1 | 2026-07-31 | APPROVED | Initial low-level design document approval |
