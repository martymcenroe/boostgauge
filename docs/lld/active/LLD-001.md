...
|----|---------|--------------|
| G1.1 | "Critical: Section 2.1 missing from LLD" | YES - Section 2.1 added with complete file manifest and path validation. |
| G1.2 | "Critical: Section ## 11 missing from LLD" | YES - Section 11 added with risks and mitigations table. |
| G1.3 | "Critical: Section ## 12 missing from LLD" | YES - Section 12 added with Definition of Done and 12.1 Traceability. |
...
| Gemini #1 | (auto) | REJECTED | Mechanical validation missing sections 2.1, 11, 12 |
