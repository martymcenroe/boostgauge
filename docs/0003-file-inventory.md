...
This document provides a complete inventory of files in the boostgauge project, organized by directory. It serves as a quick reference for agents and developers to understand the project structure.
