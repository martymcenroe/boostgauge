...
def render_face(size: int, skin: str = "stingray") -> Image.Image:
    ...
    # val_to_angle(60) = 225 - 162 = 63 deg (math), val_to_angle(100) = 225 - 270 = -45 deg (math)
    # PIL pieslice: 0 is 3 o'clock, clockwise. Math convention: 0 is 3 o'clock, counter-clockwise.
    # Math angle -> PIL angle: pil_angle = -math_angle
